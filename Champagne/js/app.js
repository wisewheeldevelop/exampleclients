/* ============================================================
   WISE CHAMPAGNE · app.js
   Scroll-driven pour sequence + UI motion
   ============================================================ */
(() => {
  'use strict';
  ...
  const navScroll = () => {
    ...
    // ivory glass only after the dark hero ends
    nav.classList.toggle('past-hero', window.scrollY > hero.offsetHeight - window.innerHeight - 80);
  };
  navScroll();
